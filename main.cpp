...
class Vehicle : public Process {
    void Behavior() {
        while (1) {
            ...
            Release(platform);
            Wait(cities[actual_base].time_of_first);
            city += 40;
            Wait(cities[actual_base].time_of_first);
        }
    };
